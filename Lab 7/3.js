...
checkAll.onclick = () =>{
    if(!checkAllSwitch){
        checkAll.classList.add("checkBoxDark")
        checkAllSwitch = 1
        switchs[0] = 0
        switchs[1] = 0
        switchs[2] = 0
        ...
        checkAll.classList.remove("checkBoxDark")
        checkAllSwitch = 0
        switchs[0] = 1
        switchs[1] = 1
        switchs[2] = 1
...
iceCream.onclick = () =>{
    if(!switchs[0]){
        iceCream.classList.add("checkBoxDark")
        switchs[0] = 1
    }
    else{
        iceCream.classList.remove("checkBoxDark")
        switchs[0] = 0
    }
    audit()
    labelStr()
...
hotDog.onclick = () =>{
    if(!switchs[1]){
        hotDog.classList.add("checkBoxDark")
        switchs[1] = 1
    }
    else{
        hotDog.classList.remove("checkBoxDark")
        switchs[1] = 0
    }
    audit()
    labelStr()
...
popcorn.onclick = () =>{
    if(!switchs[2]){
        popcorn.classList.add("checkBoxDark")
        switchs[2] = 1
    }
    else{
        popcorn.classList.remove("checkBoxDark")
        switchs[2] = 0
    }
    audit()
    labelStr()
...
cookie.onclick = () =>{
    if(!switchs[3]){
        cookie.classList.add("checkBoxDark")
        switchs[3] = 1
    }
    else{
        cookie.classList.remove("checkBoxDark")
        switchs[3] = 0
    }
    audit()
    labelStr()
